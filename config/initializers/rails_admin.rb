# RailsAdmin config file. Generated on October 13, 2013 11:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Happy Chart', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'Answer', 'AnswerDetail', 'Category', 'Form', 'Question']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'Answer', 'AnswerDetail', 'Category', 'Form', 'Question']
  ...
  #     configure :id, :integer
  #     configure :hashid, :string
  #     configure :form_id, :integer
  #     configure :living_place, :string
  #     configure :working_place, :string
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your answer_detail.rb model definition
  ...
  #     configure :id, :integer
  #     configure :answer_id, :integer
  #     configure :question_id, :integer
  #     configure :answer, :integer
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
  ...
  config.model 'Form' do
    ...
    #  end
    #end
  #   # You can copy this to a 'rails_admin do ... end' block inside your form.rb model definition
