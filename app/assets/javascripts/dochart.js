...
var doit = function() {
	...
	var happy = (-8 + attr.edu_choice * 1 + attr.env_choice * 1 + attr.commu_choice * 1 + attr.work_choice * 1 + attr.safety_choice * 1 + attr.nature_choice * 1 + attr.income_choice * 1 + attr.freetime_choice * 1) * 100 / 32;
	...
	$('#container0').highcharts({
		...
		series: [{
			...
			data: [attr.edu_choice * 100, attr.commu_choice * 100, attr.env_choice * 100,
				attr.safety_choice * 100, attr.nature_choice * 100, attr.work_choice * 100, attr.income_choice * 100, attr.freetime_choice * 100
			],
			pointPlacement: 'on',
		}],
	credits: {
